    ...
    for (toggle_type, label) in toggle_types {
        parent
            .spawn((
                ...
                BackgroundColor(Color::srgba(0.2, 0.7, 0.2, 0.8)), // Start green (active)
        ...
        parent
            ...
            .with_children(|slider_container| {
                ...
                slider_container.spawn((
                    ...
                    TextColor(Color::srgb(0.7, 0.7, 0.8)), // Light blue-gray for tooltips
                ));
...
fn create_help_section(parent: &mut ChildSpawnerCommands) {
    ...
    for line in help_text {
        parent.spawn((
            ...
            TextColor(Color::srgb(0.8, 0.9, 0.8)), // Light green for help text
        ));
    }
}
